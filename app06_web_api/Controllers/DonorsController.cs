...
namespace app06_web_api.Controllers
{
    ...
    public class DonorsController : ControllerBase
    {
        ...
        [HttpGet("{name}")]
        public IEnumerable<Donor> Get(string name)
        {
            ...
            using (var connection = new SqlConnection(connectionString))
            {
                ...
                var command = connection.CreateCommand(); // TODO: Re move TOP 10 from query below
                ...
                command.Parameters.AddWithValue("@Donor", "%" + name + "%");
